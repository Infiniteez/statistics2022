namespace Homework_7
{
    ...
    {
        static int trialCount = 30;
        static double lambda = 10;
        static double p = lambda / trialCount;
        Random r;
        Bitmap b;
        Graphics g;
        Pen penAbsolute = new Pen(Color.Black, 0.00001f);
        Pen penRelative = new Pen(Color.Red, 0.00001f);
        Pen penNormalized = new Pen(Color.Blue, 0.00001f);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            richTextBox1.AppendText("number of experiments: " + numberOfExperiments + Environment.NewLine +
                                    "number of trials: " + trialCount + Environment.NewLine +
                                    "lambda: " + lambda + Environment.NewLine +
                                    "p (lambda/trialCount): " + p + Environment.NewLine);
        }
